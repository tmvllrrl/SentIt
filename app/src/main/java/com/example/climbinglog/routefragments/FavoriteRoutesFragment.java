...
public class FavoriteRoutesFragment extends Fragment implements RouteAdapter.ItemClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mViewModel.getFavoriteRoutes().observe(getActivity(), new Observer<List<ClimbingRoute>>() {
            @Override
