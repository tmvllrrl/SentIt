...
public class TopRopeFragment extends Fragment implements RouteAdapter.ItemClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mViewModel.getTypeOfRoutes(1).observe(getActivity(), new Observer<List<ClimbingRoute>>() {
            @Override
